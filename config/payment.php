...
return [
    'alipay' => [
        'default' => [
            ...
            'return_url' => '',
            'notify_url' => 'https://0303jietiao.62.hzgqapp.com/api/notify/alipay',
            // 选填-第三方应用授权token
            'app_auth_token' => '',
    ...
    'wechat' => [
        'default' => [
            ...
            'mch_secret_key' => 'VDLLfaWhb6deiPXoqqZ3wX7uDl2paZYe',
            // 必填-商户私钥 字符串或路径
            ...
            'notify_url' => 'https://0303jietiao.62.hzgqapp.com/api/notify/wechat',
            // 选填-公众号 的 app_id
            // 可在 mp.weixin.qq.com 设置与开发->基本配置->开发者ID(AppID) 查看
            'mp_app_id' => '',
            // 选填-小程序 的 app_id
            'mini_app_id' => 'wx667731e184f394f5',
            // 选填-app 的 app_id
